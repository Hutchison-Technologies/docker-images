...
Current Prod version tag is `hutchisont/go-deploy:go125_v2.0.4`
...
```bash
docker build -t hutchisont/go-deploy:go125_v2.0.4 .
```

Once tagged, push to dockerhub via:

```bash
docker push hutchisont/go-deploy:go125_v2.0.4
```
